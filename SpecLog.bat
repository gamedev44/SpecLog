...
ping -n 4 google.com > "%log_folder%\ping_test.txt"
echo Connectivity test results saved to "ping_test.txt"
echo.

echo Checking IP Configuration...
ipconfig /all > "%log_folder%\ipconfig_all.txt"
echo IP Configuration saved to "ipconfig_all.txt"
echo.

echo Attempting to renew IP Configuration...
ipconfig /release > NUL
ipconfig /renew > "%log_folder%\ipconfig_renew.txt"
echo IP Renew results saved to "ipconfig_renew.txt"
echo.

echo Flushing DNS...
ipconfig /flushdns > "%log_folder%\dns_flush.txt"
echo DNS Flush results saved to "dns_flush.txt"
echo.

echo Resetting Network Adapter...
netsh int ip reset > "%log_folder%\netsh_reset.txt"
netsh winsock reset >> "%log_folder%\netsh_reset.txt"
echo Network Adapter reset results saved to "netsh_reset.txt"
echo.

echo Network troubleshooting complete. Results saved in the SpecLogs folder.
pause
goto menu
